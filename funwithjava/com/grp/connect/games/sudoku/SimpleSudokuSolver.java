package com.grp.connect.games.sudoku;

/**
 * This class solves the sudoku problems using the approach of backtracking
 * algorithm. This is first version of the solution . This can be optimized
 * further using other approaches like Constrained programming.
 * 
...
public class SimpleSudokuSolver {
	...
	public static void main(String args[]) {
		...
		int[][] inputBoard2  = { { 5, 0, 2, 0, 0, 6, 0, 0, 0 }, { 0, 0, 0, 0, 0, 2, 0, 0, 0 },
				{ 4, 0, 9, 1, 0, 0, 7, 6, 0 }, { 1, 0, 0, 6, 0, 0, 9, 0, 3 }, { 0, 0, 5, 0, 0, 3, 8, 0, 1 },
				{ 7, 0, 0, 0, 2, 0, 0, 0, 0 }, { 0, 6, 0, 0, 1, 0, 2, 0, 0 }, { 0, 0, 0, 2, 0, 0, 5, 0, 0 },
				{ 2, 0, 0, 0, 3, 0, 0, 0, 8 } };
		SimpleSudokuSolver simpleSudokuSolver = new SimpleSudokuSolver();
